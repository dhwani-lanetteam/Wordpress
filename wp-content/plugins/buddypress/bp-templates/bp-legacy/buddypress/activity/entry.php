				...
				<?php if ( bp_activity_can_favorite() ) : ?>
					...
					<?php if ( !bp_get_activity_is_favorite() ) : ?>
						...
						<a href="<?php bp_activity_favorite_link(); ?>" class="button fav bp-secondary-action">
							<input type="image" id="myimage" style="height:20px;width:20px;" src="<?php echo get_template_directory_uri() ?>/images/unfav.png" />
						</a>
					<?php else : ?>
						...
						<a href="<?php bp_activity_unfavorite_link(); ?>" class="button unfav bp-secondary-action">
							<input type="image" id="myimage" style="height:20px;width:20px;" src="<?php echo get_template_directory_uri() ?>/images/fav.png" />
						</a>
